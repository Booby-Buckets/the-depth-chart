...
var TEAM_TOTAL_MINUTES = 200; // 5 players × 40 min
...
var PROJ_ACC_OUT={1:1.00,2:1.10,3:1.25,4:1.40,5:1.40,6:1.40,7:1.40};

// Full D1 school → conference map (all ~360 programs)
var PROJ_SCHOOL_CONF=(function(){
  const m={};
  const data=[
    // ── TIER 1 ──
