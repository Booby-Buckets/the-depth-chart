...
declare
  ...
  readonly text[] := array[
    ...
    'team_actual_stats','postseason_games','awards'
    -- promo_codes is intentionally NOT public-read — it's locked + served via the
    -- redeem_promo() RPC in schema_rls_email_promo.sql (run that after this file).
  ];
  caches text[] := array[
