...
(function(){
  ...
  function loadHist(){
    ...
    _histPromise = fetch('scripts/data/stat_overall_history.json?v=5')
  ...
  window.TDCProjGrade.ready = Promise.all([
    ...
    _loadProjRows('scripts/data/stat_overall_projected.json?v=25').then(function(m){ if(m) setStatOverall(null, m); })
