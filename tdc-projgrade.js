...
(function(){
  ...
  window.TDCProjGrade.ready = Promise.all([
    _loadSO('scripts/data/stat_overall.json?v=5').then(function(m){ if(m) setStatOverall(m, null); }),
    _loadProjRows('scripts/data/stat_overall_projected.json?v=22').then(function(m){ if(m) setStatOverall(null, m); })
